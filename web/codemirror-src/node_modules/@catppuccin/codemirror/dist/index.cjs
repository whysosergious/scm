...
function createCatppuccinTheme(flavor) {
    ...
    const highlightStyle = language.HighlightStyle.define([
        { tag: highlight.tags.keyword, color: colors.mauve.hex },
        {
            tag: [
                highlight.tags.name,
                highlight.tags.definition(highlight.tags.name),
                highlight.tags.deleted,
                highlight.tags.character,
        ...
        },
        {
            tag: [
                ...
                highlight.tags.function(highlight.tags.propertyName),
                highlight.tags.propertyName,
        ...
        { tag: [highlight.tags.self, highlight.tags.atom], color: colors.red.hex },
        {
            tag: [highlight.tags.typeName, highlight.tags.className, highlight.tags.changed, highlight.tags.annotation, highlight.tags.namespace],
            color: colors.yellow.hex,
        },
        { tag: [highlight.tags.operator], color: colors.sky.hex },
        { tag: [highlight.tags.url, highlight.tags.link], color: colors.teal.hex },
        { tag: [highlight.tags.escape, highlight.tags.regexp], color: colors.pink.hex },
        {
            tag: [highlight.tags.meta, highlight.tags.punctuation, highlight.tags.separator, highlight.tags.comment],
        ...
        { tag: [highlight.tags.bool, highlight.tags.number], color: colors.peach.hex },
        {
