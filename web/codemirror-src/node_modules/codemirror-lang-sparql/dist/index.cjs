...
const
  ...
  Var = 122,
  Expression = 123,
  ConditionalOrExpression = 124,
  ConditionalAndExpression = 125,
  ValueLogical = 126,
  RelationalExpression = 127,
  NumericExpression = 128,
  AdditiveExpression = 129,
  MultiplicativeExpression = 130,
  UnaryExpression = 131,
  PrimaryExpression = 132,
  BrackettedExpression = 133,
  BuiltInCall = 134,
  Aggregate = 135,
  String = 137,
  Nil = 139,
  ExpressionList = 140,
  SubstringExpression = 141,
  StrReplaceExpression = 142,
  RegexExpression = 143,
  ExistsFunc = 144,
  GroupGraphPattern = 145,
  SubSelect = 146,
  WhereClause = 147,
  SolutionModifier = 148,
  GroupClause = 149,
  GroupCondition = 150,
  FunctionCall = 151,
  Iri = 152,
  ...
  OrderClause = 159,
  OrderCondition = 160,
  LimitOffsetClauses = 161,
  LimitClause = 162,
  Integer = 163,
  OffsetClause = 164,
  ValuesClause = 165,
  DataBlock = 166,
  InlineDataOneVar = 167,
  DataBlockValue = 168,
  RDFLiteral = 169,
  Langtag = 170,
  NumericLiteral = 172,
  NumericLiteralUnsigned = 173,
  Decimal = 174,
  Double = 175,
  NumericLiteralPositive = 176,
  IntegerPositive = 177,
  DecimalPositive = 178,
  DoublePositive = 179,
  NumericLiteralNegative = 180,
  IntegerNegative = 181,
  DecimalNegative = 182,
  DoubleNegative = 183,
  BooleanLiteral = 184,
  InlineDataFull = 185,
  GroupGraphPatternSub = 186,
  TriplesBlock = 187,
  TriplesSameSubjectPath = 188,
  VarOrTerm = 189,
  GraphTerm = 190,
  BlankNode = 191,
  Blank_node_label = 192,
  Anon = 193,
  PropertyListPathNotEmpty = 194,
  VerbPath = 195,
  Path = 196,
  PathAlternative = 197,
  PathSequence = 198,
  PathEltOrInverse = 199,
  PathElt = 200,
  PathPrimary = 201,
  A_predicate = 202,
  Keyword = 203,
  ...
  TriplesNodePath = 211,
  CollectionPath = 212,
  BlankNodePropertyListPath = 215,
  ObjectList = 216,
  Object$1 = 217,
  GraphNode = 218,
  TriplesNode = 219,
  Collection = 220,
  BlankNodePropertyList = 221,
  PropertyListNotEmpty = 222,
  Verb = 223,
  VarOrIri = 224,
 ...
 */
const caseInsensitive = (value, _stack) => {
  return tokens[value.toUpperCase()] || -1;
};

// This file was generated by lezer-generator. You probably shouldn't edit it.
const spec_Keyword = {__proto__:null,a:634};
const parser = lr.LRParser.deserialize({
  ...
  tokenizers: [0, 1, 2],
  topRules: {"Unit":[0,113]},
  specialized: [{term: 203, get: (value, stack) => (caseInsensitive(value) << 1), external: caseInsensitive},{term: 203, get: (value) => spec_Keyword[value] || -1}],
  tokenPrec: 5071
});
    ...
    parser: parser.configure({
        props: [
            highlight.styleTags({
                ...
                "BASE PREFIX SELECT CONSTRUCT DESCRIBE ASK WHERE DISTINCT REDUCED FROM NAMED": highlight.tags.keyword,
                // Graph pattern keywords
                "UNION OPTIONAL MINUS GRAPH SERVICE SILENT FILTER BIND AS VALUES UNDEF": highlight.tags.keyword,
                // Solution modifier keywords
                "GROUP BY HAVING ORDER ASC DESC LIMIT OFFSET": highlight.tags.keyword,
                // Update operation keywords
                "LOAD INTO TO CLEAR DROP CREATE ADD MOVE COPY INSERT DATA DELETE WITH DEFAULT ALL USING": highlight.tags.keyword,
                // Built-in function keywords
                "STR LANG LANGMATCHES DATATYPE BOUND IRI URI BNODE RAND ABS CEIL FLOOR ROUND": highlight.tags.keyword,
                "CONCAT STRLEN UCASE LCASE ENCODE_FOR_URI CONTAINS STRSTARTS STRENDS STRBEFORE STRAFTER": highlight.tags.keyword,
                "YEAR MONTH DAY HOURS MINUTES SECONDS TIMEZONE TZ NOW UUID STRUUID": highlight.tags.keyword,
                "MD5 SHA1 SHA256 SHA384 SHA512 COALESCE IF STRLANG STRDT SAMETERM": highlight.tags.keyword,
                "ISIRI ISURI ISBLANK ISLITERAL ISNUMERIC EXISTS NOT IN SUBSTR REPLACE REGEX": highlight.tags.keyword,
                // Aggregate function keywords
                "COUNT SUM MIN MAX AVG SAMPLE GROUP_CONCAT SEPARATOR": highlight.tags.keyword,
                "Var ObjectListPath/..": highlight.tags.variableName,
                String: highlight.tags.string,
                Integer: highlight.tags.integer,
                "Double Decimal": highlight.tags.float,
                "{ }": highlight.tags.brace,
                Langstag: highlight.tags.annotation,
                "TRUE FALSE": highlight.tags.bool,
                "VerbPath Namespace IriRef": highlight.tags.namespace,
                "Iri": highlight.tags.url,
                "RDFLiteral/Iri": highlight.tags.typeName,
            }),
            language.foldNodeProp.add({
                ...
                Prologue(tree) { return { from: tree.from + 7, to: tree.to }; }
            }),
        ]
    }),
});
