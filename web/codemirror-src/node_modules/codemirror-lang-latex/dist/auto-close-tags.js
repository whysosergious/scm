...
export const autoCloseField = StateField.define({
...
function getEnvironmentName(text) {
...
export const handleEnterInEnvironment = (view) => {
...
export const handleCloseBrace = (view) => {
    const { state } = view;
    const { main } = state.selection;
    if (main.from !== main.to)
        return false;
...
//# sourceMappingURL=auto-close-tags.js.map