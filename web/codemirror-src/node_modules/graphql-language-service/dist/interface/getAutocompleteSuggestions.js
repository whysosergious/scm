...
function getAutocompleteSuggestions(schema, queryText, cursor, contextToken, fragmentDefs, options) {
    ...
    if (kind === parser_1.RuleKinds.ARGUMENTS ||
        ...
        if (argDefs) {
            return (0, autocompleteUtils_1.hintList)(token, argDefs.map((argDef) => { var _a; return ({
                label: argDef.name,
    ...
    if ((kind === parser_1.RuleKinds.OBJECT_VALUE ||
        ...
        return (0, autocompleteUtils_1.hintList)(token, objectFields.map(field => { var _a; return ({
            label: field.name,
