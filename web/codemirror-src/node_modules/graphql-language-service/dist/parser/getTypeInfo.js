    ...
    forEachState(tokenState, state => {
        ...
        switch (state.kind) {
            ...
            case _1.RuleKinds.OBJECT_VALUE:
                ...
                inputObjectType =
                    objectType instanceof graphql_1.GraphQLInputObjectType ? objectType : null;
                objectFieldDefs = (_b = inputObjectType === null || inputObjectType === void 0 ? void 0 : inputObjectType.getFields()) !== null && _b !== void 0 ? _b : null;
                break;
