...
exports.ParseRules = {
    ...
    FieldsDef: [(0, RuleHelpers_1.p)('{'), (0, RuleHelpers_1.list)('FieldDef'), (0, RuleHelpers_1.p)('}')],
    FieldDef: [
        name('property'),
        (0, RuleHelpers_1.opt)('ArgumentsDef'),
        (0, RuleHelpers_1.p)(':'),
    ...
    EnumDef: [
        ...
        name('atom'),
        (0, RuleHelpers_1.list)('Directive'),
        (0, RuleHelpers_1.opt)('EnumValuesDef'),
    ],
    EnumValuesDef: [(0, RuleHelpers_1.p)('{'), (0, RuleHelpers_1.list)('EnumValueDef'), (0, RuleHelpers_1.p)('}')],
    EnumValueDef: [name('string-2'), (0, RuleHelpers_1.list)('Directive')],
    InputDef: [
        word('input'),
        name('atom'),
        (0, RuleHelpers_1.list)('Directive'),
        (0, RuleHelpers_1.opt)('InputFieldsDef'),
    ],
    InputFieldsDef: [(0, RuleHelpers_1.p)('{'), (0, RuleHelpers_1.list)('InputValueDef'), (0, RuleHelpers_1.p)('}')],
