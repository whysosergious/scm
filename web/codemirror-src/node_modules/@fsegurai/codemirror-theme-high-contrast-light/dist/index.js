...
darkBlue = '#0000ff', darkCyan = '#008080', darkGreen = '#008000', darkRed = '#c80000', darkMagenta = '#800080', darkOrange = '#d04800', darkPurple = '#6600cc', darkBrown = '#7c3400';
// UI specific colors
const invalid = darkRed, lightBackground = base00, background = base00, tooltipBackground = '#f0f0f0', selection = '#0078d4', selectionMatch = '#0078d480', cursor = darkBlue, activeBracketBg = '#e0e0e0', activeBracketBorder = darkCyan, diagnosticWarning = darkOrange, linkColor = darkBlue, visitedLinkColor = darkPurple;
// Diff/merge specific colors
const addedBackground = '#00800040', removedBackground = '#c8000040', addedText = darkGreen, removedText = darkRed;
/**
 * Enhanced editor theme styles for High Contrast Light
 */
const highContrastLightTheme = /*@__PURE__*/EditorView.theme({
    // Base editor styles
    '&': {
        color: base04,
 ...
 */
const highContrastLightHighlightStyle = /*@__PURE__*/HighlightStyle.define([
    ...
    { tag: [/*@__PURE__*/tags.function(tags.variableName), tags.labelName], color: darkBlue },
    { tag: [/*@__PURE__*/tags.definition(/*@__PURE__*/tags.function(tags.variableName))], color: darkBlue },
    { tag: [/*@__PURE__*/tags.definition(tags.variableName)], color: darkOrange },
    ...
    { tag: [tags.color, /*@__PURE__*/tags.constant(tags.name), /*@__PURE__*/tags.standard(tags.name)], color: darkOrange },
    { tag: [tags.atom, tags.bool, /*@__PURE__*/tags.special(tags.variableName)], color: darkOrange },
    // Strings and regex
    { tag: [tags.processingInstruction, tags.inserted], color: darkGreen },
    { tag: [/*@__PURE__*/tags.special(tags.string), tags.regexp], color: darkMagenta },
    { tag: tags.string, color: darkGreen },
    // Punctuation and structure
    { tag: /*@__PURE__*/tags.definition(tags.typeName), color: darkCyan, fontWeight: 'bold' },
    { tag: [/*@__PURE__*/tags.definition(tags.name), tags.separator], color: darkBlue },
    ...
    { tag: /*@__PURE__*/tags.constant(tags.name), color: darkOrange },
...
const highContrastLight = [
    ...
    /*@__PURE__*/syntaxHighlighting(highContrastLightHighlightStyle),
];
/**
 * High Contrast Light merge revert styles configuration
 */
const highContrastLightMergeStyles = {
    backgroundColor: lightBackground,
