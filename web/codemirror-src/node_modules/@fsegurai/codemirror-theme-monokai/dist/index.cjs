 ...
 */
const monokaiTheme = view.EditorView.theme({
    // Base editor styles
    '&': {
        color: base01,
 ...
 */
const monokaiHighlightStyle = language.HighlightStyle.define([
    // Keywords and control flow
    { tag: highlight.tags.keyword, color: base04, fontWeight: 'bold' },
    { tag: highlight.tags.controlKeyword, color: base04, fontWeight: 'bold' },
    { tag: highlight.tags.moduleKeyword, color: base04, fontWeight: 'bold' },
    // Names and variables
    ...
    { tag: [highlight.tags.propertyName], color: base09, fontStyle: 'normal' },
    // Classes and types
    { tag: [highlight.tags.typeName], color: base06, fontStyle: 'italic' },
    { tag: [highlight.tags.className], color: base09, fontStyle: 'italic' },
    { tag: [highlight.tags.namespace], color: base05, fontStyle: 'italic' },
    // Operators and punctuation
    { tag: [highlight.tags.operator, highlight.tags.operatorKeyword], color: base04 },
    { tag: [highlight.tags.bracket], color: base01 },
    { tag: [highlight.tags.brace], color: base01 },
    { tag: [highlight.tags.punctuation], color: base01 },
    // Functions and parameters
    { tag: [highlight.tags.function(highlight.tags.variableName), highlight.tags.labelName], color: base06 },
    { tag: [highlight.tags.definition(highlight.tags.function(highlight.tags.variableName))], color: base06 },
    { tag: [highlight.tags.definition(highlight.tags.variableName)], color: base05 },
    // Constants and literals
    { tag: highlight.tags.number, color: base08 },
    { tag: highlight.tags.changed, color: base08 },
    { tag: highlight.tags.annotation, color: invalid, fontStyle: 'italic' },
    { tag: highlight.tags.modifier, color: base08, fontStyle: 'italic' },
    { tag: highlight.tags.self, color: base08 },
    { tag: [highlight.tags.color, highlight.tags.constant(highlight.tags.name), highlight.tags.standard(highlight.tags.name)], color: base08 },
    { tag: [highlight.tags.atom, highlight.tags.bool, highlight.tags.special(highlight.tags.variableName)], color: base08 },
    // Strings and regex
    { tag: [highlight.tags.processingInstruction, highlight.tags.inserted], color: base09 },
    { tag: [highlight.tags.special(highlight.tags.string), highlight.tags.regexp], color: base07 },
    { tag: highlight.tags.string, color: base07 },
    // Punctuation and structure
    { tag: highlight.tags.definition(highlight.tags.typeName), color: base06, fontWeight: 'bold' },
    // Comments and documentation
    { tag: highlight.tags.meta, color: base02 },
    { tag: highlight.tags.comment, fontStyle: 'italic', color: base02 },
    { tag: highlight.tags.docComment, fontStyle: 'italic', color: base02 },
    // HTML/XML elements
    { tag: [highlight.tags.tagName], color: base04 },
    { tag: [highlight.tags.attributeName], color: base09 },
    // Markdown and text formatting
    { tag: [highlight.tags.heading], fontWeight: 'bold', color: base09 },
    { tag: [highlight.tags.strong], fontWeight: 'bold', color: base05 },
    { tag: [highlight.tags.emphasis], fontStyle: 'italic', color: base05 },
    // Links and URLs
    {
    ...
    { tag: highlight.tags.constant(highlight.tags.name), color: base08 },
    { tag: highlight.tags.deleted, color: invalid },
    { tag: highlight.tags.squareBracket, color: base01 },
    { tag: highlight.tags.angleBracket, color: base01 },
    // Additional specific styles
    { tag: highlight.tags.monospace, color: base01 },
    { tag: [highlight.tags.contentSeparator], color: base05 },
    { tag: highlight.tags.quote, color: base02 },
]);
/**
...
const monokai = [
    monokaiTheme,
    language.syntaxHighlighting(monokaiHighlightStyle),
];
/**
...
exports.monokaiMergeStyles = monokaiMergeStyles;
