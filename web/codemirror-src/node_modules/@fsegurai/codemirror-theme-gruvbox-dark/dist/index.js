...
// UI specific colors
const invalid = base08, darkBackground = base01, highlightBackground = '#3c383660', // Line highlight with transparency
background = base00, tooltipBackground = base01, selection = base02, selectionMatch = '#665c5480', // Selection match background
...
const gruvboxDarkHighlightStyle = /*@__PURE__*/HighlightStyle.define([
    ...
    { tag: [/*@__PURE__*/tags.function(tags.variableName), tags.labelName], color: base0A },
    ...
    { tag: [tags.color, /*@__PURE__*/tags.constant(tags.name), /*@__PURE__*/tags.standard(tags.name)], color: base0E },
    ...
    { tag: /*@__PURE__*/tags.definition(tags.typeName), color: base0D, fontWeight: 'bold' },
    ...
    { tag: /*@__PURE__*/tags.constant(tags.name), color: base0E },
