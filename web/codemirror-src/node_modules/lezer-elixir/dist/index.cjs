...
const quotedContentTokens = new lr.ExternalTokenizer((input, stack) => {
...
const sigilTokens = new lr.ExternalTokenizer((input, stack) => {
  let length = 0;
...
const immediateTokens = new lr.ExternalTokenizer((input, stack) => {
...
const beforeUnaryOpToken = new lr.ExternalTokenizer((input, stack) => {
...
const atomWordToken = new lr.ExternalTokenizer((input, stack) => {
...
const keywordWordToken = new lr.ExternalTokenizer((input, stack) => {
  let [nextCodepointString, nextOffset] = peekCodepoint(input);
  if (ATOM_START.test(nextCodepointString)) {
    do {
      input.advance(nextOffset);
...
const identifierToken = new lr.ExternalTokenizer((input, stack) => {
  let [nextCodepointString, nextOffset] = peekCodepoint(input);
...
const notInToken = new lr.ExternalTokenizer((input, stack) => {
...
const doubleSlashToken = new lr.ExternalTokenizer((input, stack) => {
...
const atToken = new lr.ExternalTokenizer((input, stack) => {
  if (input.next === CP_AT) {
    input.advance();
...
const newlineTokens = new lr.ExternalTokenizer((input, stack) => {
  if (input.next === CP_CR) {
    input.advance();
  }
...
const elixirHighlighting = highlight.styleTags({
  ...
  SpecialIdentifier: highlight.tags.special(highlight.tags.variableName),
  UnderscoredIdentifier: highlight.tags.comment,
  "String String/QuotedContent": highlight.tags.string,
  "Charlist Charlist/QuotedContent": highlight.tags.string,
  ...
  "Interpolation/#{ Interpolation/}": highlight.tags.special(highlight.tags.brace),
  ...
  // Explicit keywords
  "fn do end catch rescue after else": highlight.tags.keyword,
  // Operators
  Operator: highlight.tags.operator,
  WordOperator: highlight.tags.keyword,
  "CaptureOperand/Integer": highlight.tags.operator,
  // Module attribute
  ...
  "DocAtOperator/Operator DocAtOperator/Identifier DocAtOperator/Call/Identifier DocAtOperator/Call/Arguments/Boolean DocAtOperator/Call/Arguments/String DocAtOperator/Call/Arguments/String/QuotedContent DocAtOperator/Call/Arguments/Charlist DocAtOperator/Call/Arguments/Charlist/QuotedContent DocAtOperator/Call/Arguments/StringSigil DocAtOperator/Call/Arguments/StringSigil/QuotedContent DocAtOperator/Call/Arguments/StringSigil/SigilName DocAtOperator/Call/Arguments/StringSigil/SigilModifiers DocAtOperator/Call/Arguments/StringSigil/{ DocAtOperator/Call/Arguments/StringSigil/} DocAtOperator/Call/Arguments/StringSigil/[ DocAtOperator/Call/Arguments/StringSigil/] DocAtOperator/Call/Arguments/StringSigil/( DocAtOperator/Call/Arguments/StringSigil/)":
    highlight.tags.docString,
  // Function calls
  "Call/Identifier Call/UnderscoredIdentifier": highlight.tags.function(highlight.tags.variableName),
  ...
  "Call/Dot/Atom": highlight.tags.namespace,
  // Pipe into identifier
  "PipeOperator/Right/Identifier": highlight.tags.function(highlight.tags.variableName),
  // Function definitions
  "FunctionDefinitionCall/Identifier": highlight.tags.keyword,
  ...
  "FunctionDefinitionCall/Arguments/PipeOperator/Right/Identifier":
    highlight.tags.variableName,
  // Kernel built-in
  "KernelCall/Identifier": highlight.tags.keyword,
});
