 ...
 */
export declare function docSyntax(state: EditorState): EmmetKnownSyntax;
/**
 * Returns Emmet abbreviation type for given syntax
 */
export declare function getSyntaxType(syntax?: EmmetKnownSyntax): SyntaxType;
/**
 * Check if given syntax is XML dialect
 */
export declare function isXML(syntax: string): syntax is EmmetKnownSyntax;
/**
 * Check if given syntax is HTML dialect (including XML)
 */
export declare function isHTML(syntax: string): syntax is EmmetKnownSyntax;
/**
 * Check if given syntax name is supported by Emmet
 */
export declare function isSupported(syntax: string): syntax is EmmetKnownSyntax;
/**
 ...
 */
export declare function isCSS(syntax: string): syntax is EmmetKnownSyntax;
/**
 * Check if given syntax is JSX dialect
 */
export declare function isJSX(syntax: string): syntax is EmmetKnownSyntax;
/**
